...
class FetchHotel extends StatefulWidget {
  @override
  _FetchHotelState createState() => _FetchHotelState();
}

class _FetchHotelState extends State<FetchHotel> {
  /*
