...
class FetchApartment extends StatefulWidget {
  @override
  _FetchApartmentState createState() => _FetchApartmentState();
}

class _FetchApartmentState extends State<FetchApartment> {
  /*
