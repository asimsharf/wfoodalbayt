...
/*
 * her we put a class ApartmentRentalCard which
 * show you the cards for the product
 * on click on it tack you to another page details
 */
class ApartmentRentalCard extends StatelessWidget {
  final String imagePath, AgencyName, AgencyField;
  ApartmentRentalCard(this.imagePath, this.AgencyName, this.AgencyField);
